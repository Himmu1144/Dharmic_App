...
void _appSettingsSerialize(
  ...
  writer.writeString(offsets[1], object.selectedLanguage);
}
...
AppSettings _appSettingsDeserialize(
  ...
  final object = AppSettings(
    isFirstLaunch: reader.readBoolOrNull(offsets[0]) ?? true,
    selectedLanguage: reader.readStringOrNull(offsets[1]) ?? 'en',
  );
  object.id = id;
  return object;
}
...
extension AppSettingsQueryWhereDistinct
  ...
  QueryBuilder<AppSettings, AppSettings, QDistinct> distinctBySelectedLanguage(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
